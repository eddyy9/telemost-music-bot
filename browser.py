# -*- coding: utf-8 -*-
"""
Заход бота на встречу Яндекс Телемоста через Chromium-браузер (Playwright).

Ключевая часть — не автоклик, а патч getUserMedia:
Телемост, как любой WebRTC-клиент, просит микрофон с включённым эхоподавлением,
шумодавом и авторегулировкой громкости. Для музыки это смерть — она превратится
в булькающую кашу. Патч выключает всё это и подсовывает виртуальный кабель
вместо настоящего микрофона.
"""
